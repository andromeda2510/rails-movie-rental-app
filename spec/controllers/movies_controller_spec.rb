...
RSpec.describe MoviesController, type: :controller do
  ...
  before(:all) do
    @movie = Movie.create!({ name: 'Test title', director: 'Test', release_date: '01/20/2015',
  ...
  describe 'with invalid params' do
    it 'renders new template' do
      post :create,
           params: { movie: { name: 'Test', director: 'Guillermo del Toro', release_date: '01/20/2015',
                              status: 2, category_id: @category.id } }
